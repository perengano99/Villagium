...
public class VillagerWalkMaleAnimation implements ModelAnimation {
	...
	private static final AnimationDefinition DEFINITION = Builder.withLength(0.5F).looping()
			.addAnimation("head", new AnimationChannel(ROTATION,
					...
					new Keyframe(0.125F, degreeVec(0.0F, 1.0F, 0.0F), CATMULLROM),
					new Keyframe(0.25F, degreeVec(-1.0F, 0.0F, 0.0F), CATMULLROM),
					new Keyframe(0.375F, degreeVec(0.0F, -1.0F, 0.0F), CATMULLROM),
					new Keyframe(0.5F, degreeVec(-1.0F, 0.0F, 0.0F), CATMULLROM)
			))
			.addAnimation("body", new AnimationChannel(ROTATION,
					new Keyframe(0.0F, degreeVec(1.0F, 0.0F, 0.0F), CATMULLROM),
					new Keyframe(0.125F, degreeVec(1.0F, 1.0F, 0.0F), CATMULLROM),
					new Keyframe(0.25F, degreeVec(1.0F, 0.0F, 0.0F), CATMULLROM),
					new Keyframe(0.375F, degreeVec(1.0F, -1.0F, 0.0F), CATMULLROM),
					new Keyframe(0.5F, degreeVec(1.0F, 0.0F, 0.0F), CATMULLROM)
			))
			.addAnimation("right_arm", new AnimationChannel(ROTATION,
					new Keyframe(0.0F, degreeVec(0.0F, 0.0F, 5.0F), CATMULLROM),
					new Keyframe(0.125F, degreeVec(40.0F, 0.0F, 0.0F), CATMULLROM),
					new Keyframe(0.25F, degreeVec(0.0F, 0.0F, 5.0F), CATMULLROM),
					new Keyframe(0.375F, degreeVec(-40.0F, 0.0F, 0.0F), CATMULLROM),
