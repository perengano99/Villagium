...
public class VillagerIdleMaleAnimation implements ModelAnimation {
	...
	private static final AnimationDefinition DEFINITION = AnimationDefinition.Builder.withLength(4.0F).looping()
			...
			.addAnimation("body", new AnimationChannel(AnimationChannel.Targets.SCALE,
					...
					new Keyframe(1.0F, KeyframeAnimations.scaleVec(1.0F, 1.0F, 1.04F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(2.0F, KeyframeAnimations.scaleVec(1.0F, 1.0F, 1.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(3.0F, KeyframeAnimations.scaleVec(1.0F, 1.0F, 0.96F), AnimationChannel.Interpolations.CATMULLROM),
			...
			.addAnimation("right_arm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					...
					new Keyframe(1.0F, KeyframeAnimations.degreeVec(-1.0F, 0.0F, 6.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(2.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 5.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(3.0F, KeyframeAnimations.degreeVec(1.0F, 0.0F, 4.0F), AnimationChannel.Interpolations.CATMULLROM),
