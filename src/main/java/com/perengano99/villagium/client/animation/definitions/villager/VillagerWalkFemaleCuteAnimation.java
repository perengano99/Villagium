...
public class VillagerWalkFemaleCuteAnimation implements ModelAnimation {
	...
	private static final AnimationDefinition DEFINITION = Builder.withLength(0.5F).looping()
			.addAnimation("head", new AnimationChannel(ROTATION,
					new Keyframe(0.0F, degreeVec(0.0F, 0.0F, -1.5F), CATMULLROM),
					new Keyframe(0.125F, degreeVec(-2.0F, 3.0F, 0.0F), CATMULLROM),
					new Keyframe(0.25F, degreeVec(0.0F, 0.0F, 1.5F), CATMULLROM),
					new Keyframe(0.375F, degreeVec(-2.0F, -3.0F, 0.0F), CATMULLROM),
					new Keyframe(0.5F, degreeVec(0.0F, 0.0F, -1.5F), CATMULLROM)
			))
			.addAnimation("body", new AnimationChannel(ROTATION,
					new Keyframe(0.0F, degreeVec(0.0F, 0.0F, 0.0F), CATMULLROM),
					new Keyframe(0.125F, degreeVec(-1.0F, -3.5F, 1.2F), CATMULLROM),
					new Keyframe(0.25F, degreeVec(0.0F, 0.0F, 0.0F), CATMULLROM),
					new Keyframe(0.375F, degreeVec(-1.0F, 3.5F, -1.2F), CATMULLROM),
					new Keyframe(0.5F, degreeVec(0.0F, 0.0F, 0.0F), CATMULLROM)
			))
			.addAnimation("right_arm", new AnimationChannel(ROTATION,
					new Keyframe(0.0F, degreeVec(0, 0.56F, 7.0F), CATMULLROM),
					new Keyframe(0.125F, degreeVec(68.0F, 0.0F, 7.0F), CATMULLROM),
					new Keyframe(0.375F, degreeVec(-68.0F, 1.0F, 7.0F), CATMULLROM),
					new Keyframe(0.5F, degreeVec(0, 0.56F, 7.0F), CATMULLROM)
			))
